...
require '../PHPMailer-master/PHPMailerAutoload.php';
  if(isset($_POST['update'])){
	...
	$mail->Port = 465;
	$mail->Username = 'inventory2k17@gmail.com';
	$mail->Password = 'inventory@2k17';
	$mail->setFrom('inventory2k17@gmail.com');
	$mail->addAddress('pratikrana@ieee.org');
	$date=date("F j, Y, g:i a");
	$mail->Subject = "An Attemp has been made to change your password on ".$date;
	$mail->Body = 'Your Account Settings Has Been Interfaired with. ';
